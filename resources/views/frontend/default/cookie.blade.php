...
<script>
    $(document).ready(function() {
        if (localStorage.getItem("accept_cookie_edunova")) {
            // localStorage.removeItem("accept_cookie_edunova");
        } else {
    ...
    function cookieAccept() {
        if (typeof(Storage) !== "undefined") {
            localStorage.setItem("accept_cookie_edunova", true);
            localStorage.setItem("accept_cookie_edunova_time", "<?php echo date('m/d/Y'); ?>");
