...
class PageBuilderController extends Controller
{
    ...
    {
        return redirect(route('admin.pages'))->with('error', get_phrase('Creating new pages is disabled'));
    }
    ...
    {
        return redirect(route('admin.pages'))->with('error', get_phrase('Deleting pages is disabled'));
    }
